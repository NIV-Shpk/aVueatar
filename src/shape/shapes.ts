...
export const Shape1 = defineComponent({
  name: "Shape1",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M16 0L19.856 9.32122L29.8565 8L23.712 16L29.8565 24L19.856 22.6787L16 32L12.144 22.6787L2.14359 24L8.28799 16L2.14359 8L12.144 9.32122L16 0Z" fill="currentColor"/>'})
  },
})
//                ``               
//        .       nc       .       
...
// Shape 87 in figma
export const Shape2 = defineComponent({
  name: "Shape2",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M16.017 0L18.4 8.66546L25.4214 3.05573L22.256 11.467L31.2338 11.0557L23.729 16L31.2338 20.9443L22.256 20.533L25.4214 28.9443L18.4 23.3346L16.017 32L13.6338 23.3346L6.61234 28.9443L9.77776 20.533L0.800003 20.9443L8.30492 16L0.800003 11.0557L9.77776 11.467L6.61234 3.05573L13.6338 8.66546L16.017 0Z" fill="currentColor"/>'})
  },
})
...
// Shape 83 in figma
export const Shape6= defineComponent({
  name: "Shape6",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<g clipPath="url(#clip0_1_4205)"><path d="M11.4493 2.61355C13.4938 -0.871185 18.532 -0.871183 20.5765 2.61355L20.6507 2.74011C21.5941 4.34773 23.3134 5.34048 25.1773 5.35354L25.3242 5.35456C29.3643 5.38285 31.8834 9.74597 29.8877 13.259L29.8152 13.3866C28.8946 15.0072 28.8946 16.9928 29.8152 18.6134L29.8877 18.741C31.8834 22.2541 29.3643 26.6171 25.3242 26.6454L25.1773 26.6464C23.3134 26.6595 21.5941 27.6523 20.6507 29.2598L20.5765 29.3864C18.532 32.8712 13.4938 32.8712 11.4493 29.3864L11.375 29.2598C10.4318 27.6523 8.71227 26.6595 6.84843 26.6464L6.7017 26.6454C2.66154 26.6171 0.142494 22.2541 2.13806 18.741L2.21054 18.6134C3.13117 16.9928 3.13117 15.0072 2.21054 13.3866L2.13806 13.259C0.142494 9.74597 2.66154 5.38285 6.7017 5.35456L6.84843 5.35354C8.71229 5.34048 10.4318 4.34773 11.375 2.74011L11.4493 2.61355Z" fill="currentColor"/></g> <defs><clipPath id="clip0_1_4205"><rect width="32" height="32" fill="white"/></clipPath></defs>'})
  },
})
...
// Shape 82 in figma
export const Shape7= defineComponent({
  name: "Shape7",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path fillRule="evenodd" clipRule="evenodd" d="M17.1429 0H14.8571V13.2409L5.49442 3.87816L3.87818 5.49442L13.2409 14.8571H0V17.1429H13.2409L3.87818 26.5056L5.49442 28.1218L14.8571 18.759V32H17.1429V18.759L26.5056 28.1218L28.1218 26.5056L18.759 17.1429H32V14.8571H18.759L28.1218 5.4944L26.5056 3.87816L17.1429 13.2409V0Z" fill="currentColor"/>'})
  },
})
...
// Shape 79 in figma
export const Shape10= defineComponent({
  name: "Shape10",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path fillRule="evenodd" clipRule="evenodd" d="M19.2 0H12.8V8.27451L6.94904 2.42355L2.42355 6.94902L8.27453 12.8H0V19.2H8.27451L2.42355 25.0509L6.94904 29.5765L12.8 23.7254V32H19.2V23.7254L25.051 29.5765L29.5765 25.051L23.7254 19.2H32V12.8H23.7254L29.5765 6.94902L25.051 2.42354L19.2 8.27451V0Z" fill="currentColor"/>'})
  },
})
...
// Shape 73 in figma
export const Shape15= defineComponent({
  name: "Shape15",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4226)">
...
// Shape 66 in figma
export const Shape20= defineComponent({
  name: "Shape20",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path fillRule="evenodd" clipRule="evenodd" d="M18.608 12.0758L23.8965 6.78739C24.26 6.42397 24.8491 6.42397 25.2126 6.78739C25.576 7.15083 25.576 7.74006 25.2126 8.10349L19.9242 13.3919C21.1178 13.1237 22.5114 12.9697 24 12.9697C28.4182 12.9697 32 14.3264 32 16C32 17.6736 28.4182 19.0302 24 19.0302C22.5114 19.0302 21.1178 18.8763 19.9242 18.608L25.2126 23.8965C25.576 24.26 25.576 24.8491 25.2126 25.2126C24.8491 25.576 24.26 25.576 23.8965 25.2126L18.608 19.9242C18.8763 21.1178 19.0302 22.5115 19.0302 24C19.0302 28.4182 17.6736 32 16 32C14.3264 32 12.9697 28.4182 12.9697 24C12.9697 22.5114 13.1237 21.1178 13.3919 19.9242L8.10349 25.2126C7.74006 25.576 7.15083 25.576 6.78741 25.2126C6.42398 24.8491 6.42398 24.26 6.78741 23.8965L12.0758 18.608C10.8822 18.8763 9.48856 19.0302 8 19.0302C3.58173 19.0302 0 17.6736 0 16C0 14.3264 3.58173 12.9697 8 12.9697C9.48856 12.9697 10.8822 13.1237 12.0758 13.3919L6.78741 8.1035C6.42398 7.74008 6.42398 7.15085 6.78741 6.78741C7.15083 6.42398 7.74006 6.42398 8.10349 6.78741L13.3919 12.0759C13.1237 10.8822 12.9697 9.48858 12.9697 8C12.9697 3.58173 14.3264 0 16 0C17.6736 0 19.0302 3.58173 19.0302 8C19.0302 9.48856 18.8763 10.8822 18.608 12.0758Z" fill="currentColor"/>'})
  },
})
...
// Shape 65 in figma
export const Shape21= defineComponent({
  name: "Shape21",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path fillRule="evenodd" clipRule="evenodd" d="M18.608 12.0758L23.8965 6.78739C24.26 6.42397 24.8491 6.42397 25.2126 6.78739C25.576 7.15083 25.576 7.74006 25.2126 8.10349L19.9242 13.3919C21.1178 13.1237 22.5114 12.9697 24 12.9697C28.4182 12.9697 32 14.3264 32 16C32 17.6736 28.4182 19.0302 24 19.0302C22.5114 19.0302 21.1178 18.8763 19.9242 18.608L25.2126 23.8965C25.576 24.26 25.576 24.8491 25.2126 25.2126C24.8491 25.576 24.26 25.576 23.8965 25.2126L18.608 19.9242C18.8763 21.1178 19.0302 22.5115 19.0302 24C19.0302 28.4182 17.6736 32 16 32C14.3264 32 12.9697 28.4182 12.9697 24C12.9697 22.5114 13.1237 21.1178 13.3919 19.9242L8.10349 25.2126C7.74006 25.576 7.15083 25.576 6.78741 25.2126C6.42398 24.8491 6.42398 24.26 6.78741 23.8965L12.0758 18.608C10.8822 18.8763 9.48856 19.0302 8 19.0302C3.58173 19.0302 0 17.6736 0 16C0 14.3264 3.58173 12.9697 8 12.9697C9.48856 12.9697 10.8822 13.1237 12.0758 13.3919L6.78741 8.1035C6.42398 7.74008 6.42398 7.15085 6.78741 6.78741C7.15083 6.42398 7.74006 6.42398 8.10349 6.78741L13.3919 12.0759C13.1237 10.8822 12.9697 9.48858 12.9697 8C12.9697 3.58173 14.3264 0 16 0C17.6736 0 19.0302 3.58173 19.0302 8C19.0302 9.48856 18.8763 10.8822 18.608 12.0758Z" fill="currentColor"/>'})
...
// Shape 59 in figma
export const Shape23= defineComponent({
  name: "Shape23",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M16 2L21.12 17.68L32 30L16 26.64L0 30L10.88 17.68L16 2Z" fill="currentColor"/>'})
  },
})
...
// Shape 58 in figma
export const Shape24= defineComponent({
  name: "Shape24",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M16 0L20.5255 11.4745L32 16L20.5255 20.5255L16 32L11.4745 20.5255L0 16L11.4745 11.4745L16 0Z" fill="currentColor"/>'})
  },
})
...
// Shape 56 in figma
export const Shape26= defineComponent({
  name: "Shape26",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path fillRule="evenodd" clipRule="evenodd" d="M21.7142 0H10.2857V10.2857H4.99558e-07L0 21.7142H10.2857V32H21.7142V21.7142H32V10.2857H21.7142V0Z" fill="currentColor"/>'})
  },
})
...
// Shape 55 in figma
export const Shape27= defineComponent({
  name: "Shape27",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4264)">
    ...
    </g><defs><clipPath id="clip0_1_4264"><rect width="32" height="32" fill="white"/></clipPath></defs>`})
  },
})
...
// Shape 54 in figma
export const Shape28= defineComponent({
  name: "Shape28",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M24.9702 23.0298L17.9403 16L24.9702 8.97018L32 16L24.9702 23.0298ZM7.02982 23.0298L0 16L7.02982 8.97018L14.0596 16L7.02982 23.0298ZM16 32L8.97018 24.9702L16 17.9403L23.0298 24.9702L16 32ZM16 14.0596L8.97018 7.02982L16 0L23.0298 7.02982L16 14.0596Z" fill="currentColor"/>'})
  },
})
...
// Shape 45 in figma
export const Shape30= defineComponent({
  name: "Shape30",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4288)">
...
// Shape 44 in figma
export const Shape31= defineComponent({
  name: "Shape31",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path fillRule="evenodd" clipRule="evenodd" d="M32 16.1074L16 0L0 16.1074H15.7867L0 32H32L16.2133 16.1074H32Z" fill="currentColor"/>'})
  },
})
...
// Shape 43 in figma
export const Shape32= defineComponent({
  name: "Shape32",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path fillRule="evenodd" clipRule="evenodd" d="M16 3.97741L10.6667 0V10.6666H0L3.97741 16L4.66254e-07 21.3333H10.6667V10.6667H21.3333V0L16 3.97741ZM28.0226 16L32 10.6667H21.3333V21.3333H10.6667V32L16 28.0226L21.3333 32V21.3333H32L28.0226 16Z" fill="currentColor"/>'})
  },
})
...
// Shape 40 in figma
export const Shape33= defineComponent({
  name: "Shape33",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4302)">
...
// Shape 36 in figma
export const Shape34= defineComponent({
  name: "Shape34",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4313)">
...
// Shape 34 in figma
export const Shape36= defineComponent({
  name: "Shape36",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4318)">
...
// Shape 29 in figma
export const Shape39= defineComponent({
  name: "Shape39",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M16 0C16.5432 8.60154 23.3984 15.4568 32 16C23.3984 16.5432 16.5432 23.3984 16 32C15.4568 23.3984 8.60154 16.5432 0 16C8.60154 15.4568 15.4568 8.60154 16 0Z" fill="currentColor"/>'})
  },
})
...
// Shape 22 in figma
export const Shape41= defineComponent({
  name: "Shape41",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4344)">
...
// Shape 21 in figma
export const Shape42= defineComponent({
  name: "Shape42",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4346)">
...
// Shape 20 in figma
export const Shape43= defineComponent({
  name: "Shape43",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4349)">
...
// Shape 19 in figma
export const Shape44= defineComponent({
  name: "Shape44",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M15.9992 32V23.035L0 15.9992H8.96501L15.9992 0V8.96501L32 15.9992H23.035L15.9992 32Z" fill="currentColor"/>'})
  },
})
...
// Shape 18 in figma
export const Shape45= defineComponent({
  name: "Shape45",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M15.999 32V29.5102C7.84933 29.5102 0 24.1491 0 16H2.48792C2.48792 7.85085 7.84933 0 15.999 0V2.48979C24.1486 2.48979 32 7.85085 32 16H29.5122C29.5122 24.1491 24.1486 32 15.999 32Z" fill="currentColor"/>'})
  },
})
...
// Shape 17 in figma
export const Shape46= defineComponent({
  name: "Shape46",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4355)">
...
// Shape 16 in figma
export const Shape47= defineComponent({
  name: "Shape47",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4358)">
...
// Shape 12 in figma
export const Shape51= defineComponent({
  name: "Shape51",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: '<path d="M19.735 32C16 32 16 23.035 12.2649 23.035C7.96595 23.035 0 24.0328 0 19.7341C0 15.9992 8.96387 15.9992 8.96387 12.2643C8.96387 7.96714 7.96595 0 12.2649 0C16 0 16 8.96501 19.735 8.96501C24.0341 8.96501 32 7.96714 32 12.2643C32 15.9992 23.0346 15.9992 23.0346 19.7341C23.0346 24.0328 24.0341 32 19.735 32Z" fill="currentColor"/>'})
  },
})
...
// Shape 11 in figma
export const Shape52= defineComponent({
  name: "Shape52",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4369)">
...
// Shape 10 in figma
export const Shape53= defineComponent({
  name: "Shape53",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4372)">
...
// Shape 8 in figma
export const Shape54= defineComponent({
  name: "Shape54",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4378)">
...
// Shape 6 in figma
export const Shape56= defineComponent({
  name: "Shape56",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4383)">
...
// Shape 5 in figma
export const Shape57= defineComponent({
  name: "Shape57",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4386)">
...
// Shape 3 in figma
export const Shape59= defineComponent({
  name: "Shape59",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4392)">
...
// Shape 2 in figma
export const Shape60= defineComponent({
  name: "Shape60",
  props: ['width'],
  setup(props) {
    return () => h('svg', {...props, ...defaultProps, innerHTML: `<g clipPath="url(#clip0_1_4395)">
